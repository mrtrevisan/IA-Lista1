...
# função que retorna a heuristica de uma cidade x
def h(x):
    return heuristica[x]

# Faz a busca gulosa pelo algoritmo MELHOR ESCOLHA COM HEURISTICA.
...
# o custo é somado para efeitos de comparação
